...
### Focus
- **[Kanso](https://github.com/comitanigiacomo/kanso-web)** — Offline-first sync engine (Go, Postgres, Redis).
...
- **Studies** — Numerical Calculus, Cloud Computing Technologies, Parallel Algorithms.
